...
const gbvphysicalReportSections = require('../../app/reporting-framework/json-reports/gbv-reports/physical/indicator.json');
const gbvphysicalReportPatientListCols = require('../../app/reporting-framework/json-reports/tx-reports/tx-ml/tx-ml-report-patient-list-cols.json');

const etlHelpers = require('../../etl-helpers.js');

export class GBVPhysicalSummaryReportService extends MultiDatasetPatientlistReport {
          ...
          super.generateReport(additionalParams).then((results) => {
            if (additionalParams && additionalParams.type === 'patient-list') {
              ...
              resolve({
                ...
                result: finalResult,
                sectionDefinitions: gbvphysicalReportSections,
    ...
    return new Promise((resolve, reject) => {
      super
        ...
        .then((results) => {
          ...
          results['patientListCols'] = gbvphysicalReportPatientListCols;
